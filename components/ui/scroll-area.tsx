...
const ScrollArea = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof Primitive.Root> & {showScrollbar?: boolean}
>(({ className, children, showScrollbar = true, ...props }, ref) => (
  ...
  >
    {children}
    <Primitive.Corner />
    <ScrollBar orientation="vertical" className={showScrollbar ? '' : 'opacity-0 pointer-events-none'} />
  </Primitive.Root>
));
