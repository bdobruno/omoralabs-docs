...
const itemVariants = cva(
  "relative flex flex-row items-center gap-2 rounded-lg p-2 text-start wrap-anywhere [&_svg]:size-4 [&_svg]:shrink-0 ",
  {
    variants: {
      variant: {
        link: "transition-colors hover:bg-fd-accent/80 hover:transition-none data-[active=true]:bg-fd-primary/10 data-[active=true]:text-fd-primary data-[active=true]:hover:transition-colors",
        button:
          "transition-colors hover:bg-fd-accent/80 hover:text-fd-accent-foreground/80 hover:transition-none",
      },
      highlight: {
    ...
    <Base.SidebarContent>
      {({ collapsed, hovered, ref: asideRef, ...rest }) => (
        <div
          ...
          className={cn(
            "sticky z-20 [grid-area:sidebar] pointer-events-none *:pointer-events-auto md:layout:[--fd-sidebar-width:268px] max-lg:hidden",
            navMode === "auto"
        ...
        >
          ...
          <aside
            ...
            className={cn(
              "absolute flex flex-col w-full start-0 inset-y-0 items-end text-sm font-extralight duration-250 *:w-(--fd-sidebar-width)",
...
export function SidebarSeparator({
  ...
  return (
    <Base.SidebarSeparator
      className={cn(
        "[&_svg]:size-4 [&_svg]:shrink-0 text-muted-foreground text-xs",
        className,
      )}
      style={{
  ...
  return (
    <Base.SidebarFolderTrigger
      className={cn(
        ...
        "w-full font-medium lg:text-xs text-lg",
        className,
      )}
      style={{
