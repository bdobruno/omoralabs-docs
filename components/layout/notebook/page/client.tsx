  ...
  return (
    ...
    >
      <Collapsible
        ...
        data-toc-popover=""
        className={cn(
          'sticky top-(--fd-docs-row-2) z-10 [grid-area:toc-popover] h-(--fd-toc-popover-height) max-xl:layout:[--fd-toc-popover-height:--spacing(10)]',
          className,
        )}
        {...rest}
      >
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-fd-muted-foreground truncate font-normal text-sm">{index === 0 ? "Previous" : "Next"}</p>
      </div>
      <p>
        {item.name ?? (index === 0 ? "Previous" : "Next")}
      </p>
    </Link>
  );
}
