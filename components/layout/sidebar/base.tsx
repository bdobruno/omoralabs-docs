...
export function SidebarTrigger({ children, className, ...props }: ComponentProps<'button'>) {
...
export function SidebarCollapseTrigger({ className, ...props }: ComponentProps<'button'>) {
