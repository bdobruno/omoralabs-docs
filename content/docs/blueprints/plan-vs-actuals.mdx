...
1. Clone or fork the <a href="https://github.com/omoralabs/plan-vs-actuals" target="_blank">GitHub</a> repository
2. Replace the CSVs with your own data following the provided [semantic contracts](/semantic-layers)
