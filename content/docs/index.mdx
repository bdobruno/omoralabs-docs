---
title: Introduction
description: "Reusable finance data components - transformations, semantic dimensions, and reporting blocks — for building production-grade analytics pipelines. Code-first, version-controlled, no vendor lock-in."
---
