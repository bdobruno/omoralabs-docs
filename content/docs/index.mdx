---
title: Introduction
description: "Omora Labs finance analytics components and blocks are a set of reusable components and blocks for building modern finance analytics. Works with modern data stacks and analytics tools."
---
...
- No Vendor Lock In: Built with vendor-agnostic architecture so you can switch BI tools or data warehouse providers without reworking your code.
...
The architecture is intentionally vendor-agnostic, separating data models, business logic, and presentation. This lets you change BI tools or data warehouse providers without rewriting your core logic.

You can evolve your stack over time - from [Snowflake](https://www.snowflake.com) to [BigQuery](https://console.cloud.google.com/bigquery), from [Looker](https://lookerstudio.google.com/) to [Hex](https://hex.tech/) - while keeping your components and blocks intact. Your data model stays portable and future-proof.
