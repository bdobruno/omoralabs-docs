...
description: Computes standardized customer quantity metrics (starting base, movements, net new, and ending balance) over time and by value type.
---

export const table_name = "customer_count_view"
export const caption = "Customer quantity metrics derived from customer counts and revenue changes."
...
- Facts: [Customer Count](/facts/customer-count) and [Revenue Changes](/facts/revenue-changes)
