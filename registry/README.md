...
`npm install @omoralabs`

## Documentation

Visit docs.omoralabs.com to view the full documentation.

## License

This project is licensed under the terms of the [MIT license](https://github.com/bdobruno/omoralabs-docs/blob/main/LICENSE).